...
export default function AppHeader() {
  ...
  const isActive = (href: string) => {
    ...
    if (href === '/lista-de-deseos') return pathname.startsWith(href)
        ...
        <div className="header-content">
          <div className="header-left">
            <Link href="/" className="logo-container" aria-label="Sisi - Inicio">
              <svg className="logo-icon" viewBox="0 0 40 40" fill="currentColor" aria-hidden="true">
          ...
          <div className="header-right">
            <SearchDropdown />
            <button className="search-mobile-btn" onClick={() => setSearchOpen(true)} aria-label="Buscar productos">
